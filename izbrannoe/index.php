...
$faviritFilter = ['ID' => json_decode($_COOKIE['favorit'])];
?>

<div class="gray_bg">
    <div class="standart_width">
        <? if (json_decode($_COOKIE['favorit'])) : ?>
            <div class="catalog_list"><? $APPLICATION->IncludeComponent(
                                            "bitrix:news.list",
                                            "book_list",
                                            array(
